...
{
    public partial class newReturn : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string productPurpose = "forReturned";
                string strFilter =
                    " productCheck = " + "'" + productCheck + "'" +
                    " and productPurpose = " + "'" + productPurpose + "'";

                productStockRelationTable.DefaultView.RowFilter = strFilter;
                //Session["view_productStockRelationIn"] = productStockRelationTable.DefaultView.ToTable();

                //productPurpose = "forReturned";
                //strFilter =
                //    " productCheck = " + "'" + productCheck + "'" +
                //    " and productPurpose = " + "'" + productPurpose + "'";

                //productStockRelationTable.DefaultView.RowFilter = strFilter;
                //Session["view_productStockRelationOut"] = productStockRelationTable.DefaultView.ToTable();

                //Session["view_productStockRelation"] = Session["view_productStockRelationIn"];
        ...
        protected void btnOk_Click(object sender, EventArgs e)
        {
            if (inputCheck())
            {
                ...
                DataColumn colSynopsis = new DataColumn("returnedSynopsis", System.Type.GetType("System.String"));
                DataColumn colReturnedTag = new DataColumn("returnedTag", System.Type.GetType("System.String"));
                ...
                DataTable returnedTable = new DataTable("addTable");

                returnedTable.Columns.Add(colProductPurposeRelationId);
                returnedTable.Columns.Add(colApplyUsrId);
                returnedTable.Columns.Add(colApproveUsrId);
                returnedTable.Columns.Add(colSynopsis);
                returnedTable.Columns.Add(colReturnedTag);
                returnedTable.Columns.Add(colProductStockId);
                returnedTable.Columns.Add(colManId);

                returnedRow = returnedTable.NewRow();
                returnedRow["productPurposeRelationId"] = productPurposeRelationId;
                returnedRow["applyUsrId"] = applyUsrId;
                returnedRow["approveUsrId"] = approveUsrId;
                returnedRow["returnedSynopsis"] = returnedSynopsis;
                returnedRow["returnedTag"] = returnedTag;
                returnedRow["productStockId"] = productStockId;
                returnedRow["custManId"] = custManId;
                returnedTable.Rows.Add(returnedRow);

                dataSet.Tables.Add(returnedTable);
                #endregion

                ReturnedProductProcesss rpp = new ReturnedProductProcesss(dataSet);
                rpp.MyDst = dataSet;

                rpp.Add();
                Xm_db xmDataCont = Xm_db.GetInstance();

                int businessProductId = int.Parse(rpp.StrRtn);
        ...
        protected void selectOk_Click(object sender, EventArgs e)
        {
            ...
            returnProductGV.Columns[2].Visible = false;
            returnProductGV.Columns[3].Visible = true;

            returnProductGV.Caption = "送修产品";
            returnProductGV.DataSource = newDs;
            returnProductGV.DataBind();
        ...
        {
            returnProductGV.Columns[2].Visible = true;
            returnProductGV.Columns[3].Visible = false;

            returnProductGV.Caption = "产品信息";
            returnProductGV.DataSource = Session["view_productStockRelation"];
            returnProductGV.DataBind();
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            //Session["view_productStockRelation"] = Session["view_productStockRelationOut"];
            returnProductGV.DataSource = Session["view_productStockRelation"];
            returnProductGV.DataBind();
        }
