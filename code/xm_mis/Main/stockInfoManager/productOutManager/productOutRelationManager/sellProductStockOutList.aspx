<%@ Page Title="" Language="C#" MasterPageFile="~/Main/MasterPage.master" AutoEventWireup="true" CodeBehind="sellProductStockOutList.aspx.cs" Inherits="xm_mis.Main.stockInfoManager.productOutManager.productOutRelationManager.sellProductStockOutList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MasterMainContent" runat="server">
    <p>
        <br />
&nbsp;<asp:GridView ID="businessProductGV" runat="server" AllowPaging="True" 
        AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
        BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" Caption="销售产品预订出库信息" 
