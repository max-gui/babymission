<%@ Page Title="" Language="C#" MasterPageFile="~/Main/MasterPage.master" AutoEventWireup="true" CodeBehind="sellProductStockOutView.aspx.cs" Inherits="xm_mis.Main.stockInfoManager.productOutManager.productOutRelationManager.sellProductStockOutView" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MasterMainContent" runat="server">
    <asp:GridView ID="sellProductGV" runat="server" AllowPaging="True" 
        AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
        BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" Caption="销售产品信息" 
        CellPadding="4" GridLines="Horizontal" HorizontalAlign="Center" 
        onpageindexchanging="sellProductGV_PageIndexChanging" 
        onsorting="sellProductGV_Sorting" style="margin-left: 0px">
        <Columns>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:GridView ID="projectNeedGV" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="mainContractTag" HeaderText="主合同号" />
