...
{
    public class ProductStockProcess : SelectLogic
    {
        public ProductStockProcess(DataSet dataSet)
            : base(dataSet)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
            tps = (tbl_productStock_Old)InitDatabaseProc("xm_mis.db.tbl_productStock_Old");
        }

        private tbl_productStock_Old tps = null;
        ...
        {
            MyDst = tps.RealProductStockCheckManView();
        ...
        {
            tps.ProductInCheck(productInCheckId, check, checkText, checkTextName, contentType);
        }
        ...
        public string Add_includeError()
        {
            ...
            string productStockId = tps.SelectAdd(MyDst, ref error);
