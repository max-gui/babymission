...
namespace xm_mis.db
{
    public class view_subContract_supplier : DataBase
    {
        ...
        public DataSet SelectView()
        {
            ...
            string strSQL =
                "SELECT " +
                "* " +
                "FROM view_subContract_supplier ";
            ...
            projTagDataAdapter.Fill(myDataSet, "view_subContract_supplier");

            return myDataSet;
        }

        public DataSet SelectFullInfoView()
        {
            SqlCommand sqlCmd = null;
            ...
            string strSQL =
                "SELECT " +
                "* " +
                "FROM view_full_subContractInfo ";
            ...
            DataSet myDataSet = new DataSet();
            projTagDataAdapter.Fill(myDataSet, "view_full_subContractInfo");
