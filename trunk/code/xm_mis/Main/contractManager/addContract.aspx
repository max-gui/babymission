<%@ Page Title="" Language="C#" MasterPageFile="~/Main/MasterPage.master" AutoEventWireup="true" CodeBehind="addContract.aspx.cs" Inherits="xm_mis.Main.contractManager.addContract" %>
...
<p>
    项目号：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <asp:DropDownList ID="ddlProjectTag" runat="server" AutoPostBack="True" 
        onselectedindexchanged="ddlProjectTag_SelectedIndexChanged">
    </asp:DropDownList>
</p>
<p>
    主合同编号：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
