<%@ Page Title="" Language="C#" MasterPageFile="~/Main/MasterPage.master" AutoEventWireup="true" CodeBehind="subContractToEdit.aspx.cs" Inherits="xm_mis.Main.contractManager.subContractToEdit" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    style="margin-left: 0px" onpageindexchanging="subProductGV_PageIndexChanging" 
            onsorting="subProductGV_Sorting">
        <Columns>
