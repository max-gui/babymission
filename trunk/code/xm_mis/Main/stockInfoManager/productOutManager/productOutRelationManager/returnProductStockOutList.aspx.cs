...
{
    public partial class returnProductStockOutList : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Main/stockInfoManager/productOutManager/productOutRelationManager/returnProductStockOutView.aspx");
        }
        ...
        protected void btnDelAccept_Click(object sender, EventArgs e)
        {
            ...
            if (businessProdEdit.Count() > 0)
            {
                ...
                xmDataCont.Return_businessProduct_del(
