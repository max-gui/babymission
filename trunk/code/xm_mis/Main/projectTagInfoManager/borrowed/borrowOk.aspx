<%@ Page Title="" Language="C#" MasterPageFile="~/Main/MasterPage.master" AutoEventWireup="true" CodeBehind="borrowOk.aspx.cs" Inherits="xm_mis.Main.projectTagInfoManager.borrowed.borrowOk" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MasterMainContent" runat="server">
    ...
    <asp:GridView ID="projectInfoGV" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="applymentUsrName" HeaderText="借用申请人" />
