...
{
    public partial class borrowOk : System.Web.UI.Page
    {
        ...
        //        {
        //            dr["cust"] = dr["applymentUsrName"].ToString() + strCustName;
        //        }
        //        else
        //        {
        //            dr["cust"] = dr["custCompName"].ToString() + strCustName;
        //        }
        //    }
        //}
        ...
        protected void btnMoreInfo_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Main/projectTagInfoManager/borrowed/borrowDetail.aspx");
        }
    }
}