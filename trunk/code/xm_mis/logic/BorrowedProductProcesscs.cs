...
{
    public class BorrowedProductProcesscs : SelectLogic
    {
        public BorrowedProductProcesscs(DataSet dataSet)
            : base(dataSet)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
            tbp = (tbl_borrowedProduct)InitDatabaseProc("xm_mis.db.tbl_borrowedProduct");
        }

        private tbl_borrowedProduct tbp = null;
