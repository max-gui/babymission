...
{
    public class ReturnedProductProcesss : SelectLogic
    {
        public ReturnedProductProcesss(DataSet dataSet)
            : base(dataSet)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
            trp = (tbl_returnedProduct)InitDatabaseProc("xm_mis.db.tbl_returnedProduct");
        }

        private tbl_returnedProduct trp = null;
        ...
        //{
        //    return trp.CompProjectCount(dateCount, custCompId);
        //}
        ...
        {
            StrRtn = trp.SelectAdd(MyDst);
        }

        //public void OtherAdd()
        //{
        //    StrRtn = trp.OtherAdd(MyDst);
        //}
