...
namespace xm_mis.logic
{
    public class UserProcess : SelectLogic
    {
            ...
            : base(dataSet)
        {
            ...
            // TODO: 在此处添加构造函数逻辑
            //
            vuiDB = (view_usr_info)InitDatabaseProc("xm_mis.db.view_usr_info");
            tu = (tbl_usr)InitDatabaseProc("xm_mis.db.tbl_usr");
            //td = (tbl_department)("tbl_department");
            ta = (tbl_authority)InitDatabaseProc("xm_mis.db.tbl_authority");
            //tt = (tbl_title)("tbl_title");
            tud = (tbl_usr_department)InitDatabaseProc("xm_mis.db.tbl_usr_department");
            tua = (tbl_usr_authority)InitDatabaseProc("xm_mis.db.tbl_usr_authority");
            tut = (tbl_usr_title)InitDatabaseProc("xm_mis.db.tbl_usr_title");
        }
